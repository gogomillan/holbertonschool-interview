...
You may have noticed that basic binary search does not necessarily return the
index of the first value in the array (if this value appears more than once in
the array). In this exercise, youll have to solve this problem.
...
- Every time you split the array, you have to print the new array (or subarray)
  youre searching in (See example)
- You have to use recursion. You may only use one loop (while, for, do while,
...
#### Files:
\[ [0-advanced_binary.c](0-advanced_binary.c) \]
