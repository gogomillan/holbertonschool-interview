...
- The root node must be freed and replace with the last level-order node of the
  heap
- Once replaced, the heap must be rebuilt if necessary
- If your function fails, return 0

Note: In order for the main file to compile, you are provided with
[this](https://intranet.hbtn.io/rltoken/OMtzMIkyehMIYW1hg1rzvw) static library.
This library wont be used during correction, its only purpose is for testing.
...
#### Files:
\[ [0-heap_extract.c](0-heap_extract.c) \]
