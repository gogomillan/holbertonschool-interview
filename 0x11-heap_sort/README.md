...
[Heap sort](https://intranet.hbtn.io/rltoken/SipKuh8bwYl5hTPAGFqutw) algorithm
- Prototype: void heap_sort(int \*array, size_t size);
- You must implement the sift-down heap sort algorithm
- Youre expected to print the array after each time you swap two elements (See
  example below)

Write in the file 0-O, the big O notations of the time complexity of the Heap
